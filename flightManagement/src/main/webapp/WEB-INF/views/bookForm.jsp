...
<f:errors path="timeOut" cssClass="error"></f:errors>
			...
			<f:input path="Departure"  id="txtDateFrom" class="input" placeholder="Departure"  />
			<f:errors path="Departure" cssClass="error"></f:errors>
			</div>
			<div class="form-group">
			<label for="password">Return</label>
			<f:input path="Freturn"  id="txtDateTo" class="input" placeholder="Return"  />
			<f:errors path="Freturn" cssClass="error"></f:errors>
			</div>
			<div class="form-group">
			<label for="password">FlightType</label>
			<f:input path="FlightType"  class="input" placeholder="FlightType"  />
			<f:errors path="FlightType" cssClass="error"></f:errors>
			</div>
			<div class="form-group">
			<label for="password">FlightClass</label>
		<f:input path="FlightClass"  class="input" placeholder="FlightClass" />
			...
			<div class="form-group">
			<label for="password">Traveler</label>
		
			
		<f:input path="Traveler"  class="input" placeholder="Traveler" />
