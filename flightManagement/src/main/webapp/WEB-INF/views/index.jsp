  ...
  <body>
    ...
    <section class="section__container booking__container">
      ...
      <f:form action="${url_login }" modelAttribute="command">
        ...
        <button class="btn">login</i></button>
      </f:form>
    </section>
    ...
    <section class="section__container plan__container">
      ...
      <div class="plan__grid">
        ...
        <div class="plan__image">
          <img src="${url_plan1}" alt="plan" />
          <img src="${url_plan2}" alt="plan" />
          <img src="${url_plan3}" alt="plan" />
        </div>
      </div>
    </section>
    ...
    <section class="section__container lounge__container">
     <s:url var="url_lounge1" value="/static/img/lounge-1.jpg"/>
      ...
      <div class="lounge__image">
        <img src="${url_lounge1 }" alt="lounge" />
        <img src="${url_lounge2 }" alt="lounge" />
      </div>
    ...
    <footer class="footer">
      <div class="section__container footer__container">
        <div class="footer__col">
          ...
          <p>
            ...
            satisfaction and a passion for air travel, Thames Airlines offers
      ...
      <div class="section__container footer__bar">
        <p>Copyright © 2024 Thames International college. All rights reserved.</p>
        <div class="socials">
