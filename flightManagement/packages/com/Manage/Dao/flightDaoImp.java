...
public class flightDaoImp  extends BaseDao implements flightDao{
	...
	public flight findById(Integer flightId) {
		String sql="SELECT userId,destination,destinationTwo,Departure,timeIn,timeOut,freturn,flightStatus,traveler,flightId,flightType,flightClass"+" "+"FROM  flight_table WHERE flightId=?";
	...
	public List<flight> findAll() {
		String sql="SELECT userId,destination,destinationTwo,Departure,timeIn,timeOut,freturn,flightStatus,traveler,flightId,flightType,flightClass"+" "+"FROM  flight_table";
